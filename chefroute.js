...
var check = require("../models/check.js"),
    ...
    chef=require("../models/chef.js");
var middleware = require("../middleware");
var {isLoggedIn} = middleware;    

// function isLogIn(req,res,next){
//     console.log("ïn isLogIn",req.user);
...
fooda.get('/:username',function(req, res) {
    var username = req.params.username;
    console.log("in chef routes"+req.user);
...
fooda.get('/myorders/:username',isLoggedIn,function(req, res) {
    var username = req.params.username;
...
fooda.post('/order/:username/:itemid',function(req, res) {
    var username = req.params.username,
...
*/
fooda.post('/confirm/:username/:itemid',function(req, res) {
    var username = req.params.username,
        itemid = req.params.itemid;
